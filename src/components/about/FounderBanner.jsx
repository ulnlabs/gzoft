    ...
    return (
        ...
        <div className="relative flex xl:w-full pt-20 xl:items-center justify-center items-center flex-col ">
            <div className="relative xl:p-6 text-center flex justify-center overflow-hidden">
                ...
                <div className="bg-gradient-to-t absolute bottom-0 w-full md:bottom-0 xl:bottom-0 h-60 -ml-1 md:w-[440px] xl:w-[420px]  z-40 from-black to-transparent"></div>
                <div className="bg-gradient-to-t absolute bottom-4 w-full md:bottom-0 xl:bottom-4 h-60 -ml-1 md:w-[440px] xl:w-[420px]  z-40 from-black to-transparent"></div>
