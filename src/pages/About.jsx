    ...
    <div className="container mx-auto">
      ...
      <div className="xl:pt-36 pt-28 md: w-full  ">
        ...
        <div className=" flex xl:flew-row gap-14 xl:w-[80%] justify-around flex-col w-full xl:mx-auto  items-start">
          <div className=" w-full xl:scale-0 scale-110" >
            <FounderBanner />
          </div>
          <div className=" pt-5 ">
      ...
      <div className="pt-52 ">
        ...
        <div className="flex flex-wrap w-[80%] gap-20 mx-auto justify-between">
          {
      ...
      <div className="pt-52">
        <Heading title={"GALLERY"} heading="Our Agency Snaps" />
        <p className="text-white/80 font-satoshi text-lg w-[35%] float-right pt-5 " >From team outings and office shenanigans to special events and celebrations, these photos capture the essence of our vibrant culture and the bonds that unite us.</p>
