...
function HeroHead() {
  return (
    <div className="container px-6 top-0 left-0 w-full h-fit mt-[6rem] py-[2rem] flex lg:items-end items-start max-lg:flex-col justify-start gap-6">
      <div className="flex flex-col gap-4 items-start justify-center lg:w-1/2">
        <h1 className="text-3xl md:text-4xl font-bold w-3/4 text-left text-gray-800">
      ...
      <div className="lg:w-1/2 flex flex-col items-end justify-end">
        <div className="md:w-[500px]">
          <div className="flex items-start gap-4 max-md:flex-col py-2">
            <img src={herouser} alt="hero user" />
            <p className="text-xl font-bold max-md:text-sm text-md text-gray-800">
