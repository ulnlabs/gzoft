...
function Button({ text = "GET IN TOUCH", className, size = 1 }) {
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center border border-primary rounded-4xl text-dark group cursor-pointer max-sm:h-[40px] ${size === 1 ? "h-[40px]" : "h-[50px]"} ${className}`}
    >
      <p
